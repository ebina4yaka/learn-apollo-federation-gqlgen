...
var file_accounts_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x22, 0x32, 0x0a, 0x04, 0x55, 0x73,
	...
	,
...
var file_accounts_proto_goTypes = []interface{}{
	(*User)(nil),      // 0: accounts.User
	(*UserQuery)(nil), // 1: accounts.UserQuery
}
var file_accounts_proto_depIdxs = []int32{
	1, // 0: accounts.UserService.FindUserByID:input_type -> accounts.UserQuery
	0, // 1: accounts.UserService.FindUserByID:output_type -> accounts.User
...
type UserServiceClient interface {
	FindUserByID(ctx context.Context, in *UserQuery, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) FindUserByID(ctx context.Context, in *UserQuery, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/accounts.UserService/FindUserByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	FindUserByID(context.Context, *UserQuery) (*User, error)
}
...
func (*UnimplementedUserServiceServer) FindUserByID(context.Context, *UserQuery) (*User, error) {
...
func _UserService_FindUserByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/accounts.UserService/FindUserByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).FindUserByID(ctx, req.(*UserQuery))
	}
